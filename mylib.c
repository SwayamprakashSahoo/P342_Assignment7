...
void euler(double x, double y, double t, double h, int n)
{
	FILE* fptr;
	if (n == 1)
	{
		if (h == 0.5)
			fptr = fopen("C:/Users/sahoo/Desktop/P342/euler1a.txt", "w");
		else if (h == 0.2)
			fptr = fopen("C:/Users/sahoo/Desktop/P342/euler1b.txt", "w");
		else if (h == 0.05)
			fptr = fopen("C:/Users/sahoo/Desktop/P342/euler1c.txt", "w");
		else
			fptr = fopen("C:/Users/sahoo/Desktop/P342/euler1d.txt", "w");
	}

	else
	{
		if (h == 0.5)
			fptr = fopen("C:/Users/sahoo/Desktop/P342/euler2a.txt", "w");
		else if (h == 0.2)
			fptr = fopen("C:/Users/sahoo/Desktop/P342/euler2b.txt", "w");
		else if (h == 0.05)
			fptr = fopen("C:/Users/sahoo/Desktop/P342/euler2c.txt", "w");
		else
			fptr = fopen("C:/Users/sahoo/Desktop/P342/euler2d.txt", "w");
	}
...
double shoot(double u, double v, double x, double t, double h, int a)
{
	FILE* fptr;
	if (h == 0.5)
		fptr = fopen("C:/Users/sahoo/Desktop/P342/shoot1.txt", "w");
	else if (h == 0.2)
		fptr = fopen("C:/Users/sahoo/Desktop/P342/shoot2.txt", "w");
	else if (h == 0.05)
		fptr = fopen("C:/Users/sahoo/Desktop/P342/shoot3.txt", "w");
	else
		fptr = fopen("C:/Users/sahoo/Desktop/P342/shoot4.txt", "w");
